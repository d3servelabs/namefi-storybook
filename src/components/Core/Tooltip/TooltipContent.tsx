...
export const TooltipContent = ({children, ...props}: ContentProps) => {
  return (
    <div className={cn(' duration-200 w-100 border rounded-2.5 bg-[#313131] border-primary-500 pt-6 pr-12 pb-8 pl-8 flex gap-4 drop-shadow-[0_0px_1px_rgba(198, 238, 219, 0.1)]')} {...props}>
        {children?.[0]}
