    ...
    <div className='relative rounded-[32px] bg-[#111] drop-shadow-[0_0_20px_rgba(255,239,239,0.15)] py-12 px-6 '>
        <div className='w-[460px] flex flex-col gap-5 '>
            ...
            <div className='min-w-[234px] p-4 flex flex-col items-center justify-center gap-6 '>
                ...
                <a className='font-400 underline text-xs font-primary text-brand-300' 
                    href="#">Please verify your email.</a>
            </div>
            <div className='relative h-[41.6px] flex items-center justify-between
                before:absolute
                before:-top-5
                before:left-0
                before:w-full
