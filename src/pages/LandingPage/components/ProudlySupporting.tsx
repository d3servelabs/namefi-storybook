...
export const ProudlySupporting = () => {
	return (
		<div className="w-full max-w-[1400px] min-h-[166px] flex flex-col max-lg:gap-2">
			<p className="font-primary text-lg font-normal text-brand-300 tracking-wide self-start ">
				Proudly supporting
			</p>
