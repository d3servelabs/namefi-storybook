...
export const Message2 = () => {
    return (
        <div className='w-full h-[260px] xl:h-[309px] flex flex-col items-start justify-end gap-6 xl:gap-12'>
            ...
            <p className='font-xl tracking-wider text-lg xltext-[21px] text-brand-300 '>$NFSC is a <span className='text-brand-blue'>service credit issued by <NamefiBrandText text='Namefi' color='' fontSize='21px' /> </span> for you to purchase DNS domains. You can burn $USDC or $ETH to mint $NFSC.</p>
