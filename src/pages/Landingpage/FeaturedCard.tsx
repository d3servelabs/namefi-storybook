    ...
    return (
        <div  className='relative w-full max-w-[1400px]'>
            <div className='absolute left-0 top-[3rem] font-bold tracking-wider flex justify-between z-10  flex-row items-center'>
                <NamefiBrandText className="text-2xl lg:text-5xl text-primary-500">Namefi</NamefiBrandText>
                <p className=' text-xl lg:text-4xl text-primary-500 '>Features</p>
            </div>
            <div
                className='relative w-full ml-auto max-w-[1230px] min-h-[736px] rounded-5 py-14 pt-64 bg-[#24242480] px-3 lg:px-0'>
