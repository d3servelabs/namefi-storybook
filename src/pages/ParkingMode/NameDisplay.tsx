	...
	return (
		<div
			...
			<div className="flex flex-col justify-center items-center py-12 px-10 md:py-16 md:px-24 ">
				<div className="text-3xl md:text-6xl leading-tight text-[#fff]">
					{name}
				</div>
			...
			<div
				className="flex justify-end items-center mt-4 absolute right-2.5 bottom-2.5 md:right-6 md:bottom-4 cursor-pointer origin-bottom-right scale-50 xl:scale-100"
